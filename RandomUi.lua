...
local library = {colorpicking = false;tabbuttons = {};tabs = {};options = {};flags = {};scrolling = true;playing = false;multiZindex = 200;toInvis = {};libColor = Color3.fromRGB(255, 60, 40);disabledcolor = Color3.fromRGB(233, 0, 0);blacklisted = {Enum.KeyCode.W,Enum.KeyCode.A,Enum.KeyCode.S,Enum.KeyCode.D,Enum.UserInputType.MouseMovement or Enum.UserInputType.Touch,Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch}}
...
function draggable(a)
	...
	a.InputBegan:Connect(function(h)
		if h.UserInputType == Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch or h.UserInputType == Enum.UserInputType.Touch then
			c = true; 
			e = h.Position;
			f = a.Position;
	...
	a.InputChanged:Connect(function(h)
		if h.UserInputType == Enum.UserInputType.MouseMovement or Enum.UserInputType.Touch or h.UserInputType == Enum.UserInputType.Touch then 
			d = h 
		end 
	end)
				...
				function toggle:addColorpicker(args)
					...
					hue.MouseEnter:Connect(function()
						local input = hue.InputBegan:connect(function(key)
							if key.UserInputType == Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch then
								while heartbeat:wait() and inputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch) do
